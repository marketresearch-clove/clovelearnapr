      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          <select
            ...
            className="px-2 sm:px-3 py-1.5 sm:py-2 pr-6 sm:pr-8 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-xs sm:text-sm text-gray-700"
          >
        ...
        <div className="flex bg-gray-100 p-1 rounded-xl flex-wrap gap-1 sm:gap-0 w-full sm:w-fit">
          {[
            ...
            <button
              ...
              className={`flex-1 sm:flex-none px-1.5 sm:px-3 py-1 sm:py-2 text-[9px] sm:text-[11px] font-bold uppercase rounded-lg transition-all flex items-center justify-center gap-0.5 sm:gap-1.5 whitespace-nowrap ${sortBy === metric.id
                ? 'bg-white text-primary shadow-sm'
                : 'text-gray-500 hover:text-gray-700'
                }`}
              title={`Sort by ${metric.label}`}
            >
              <span className="material-symbols-rounded text-xs sm:text-base">{metric.icon}</span>
